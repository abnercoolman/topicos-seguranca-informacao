...
for nome_algoritmo, cipher_suite in cipher_suites.items():
    for tamanho_bloco in tamanhos_bloco:
        # Criptografia
        with open('introducao-a-programacao-web.pdf', 'rb') as arquivo:
            texto = arquivo.read()
        ...
        with open(f'arquivo_descriptografado_{nome_algoritmo}_{tamanho_bloco}.pdf', 'wb') as arquivo_descriptografado:
        ...
        print(
            f'Arquivo "introducao-a-programacao-web.pdf" criptografado e descriptografado com o algoritmo {nome_algoritmo} e tamanho de bloco {tamanho_bloco}.')
